...
title: "DAns, Mitochondria quantification using mitoTracker staining"
...
#Load
data_nuc <- read.delim("results_mitoTracker/FilteredNuclei_cellbody_final.csv", sep = ",") 
data_cyt <- read.delim("results_mitoTracker/Cytoplasm.csv", sep = ",") 
data_cyt_filtered <- read.delim("results_mitoTracker/Filterd_Cytoplasm.csv", sep = ",") 
...
ggplot(data,aes(x= Metadata_SampleID, y= mitoTracker_MeanCount, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  scale_fill_manual(values=alpha(c("darkblue" , "red"), 0.1)) +
  geom_boxplot(width=0.1)+
  theme_classic()  + geom_hline(yintercept = 0.35)
```
...
ggplot(data,aes(x= Metadata_SampleID, y= mitoTracker_MeanLength, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  scale_fill_manual(values=alpha(c("darkblue" , "red"), 0.1)) +
  geom_boxplot(width=0.1)+
  theme_classic()  + geom_hline(yintercept = 0.07)
```
...
ggplot(data,aes(x= Metadata_SampleID, y= Branchpoints, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  scale_fill_manual(values=alpha(c("darkblue" , "red"), 0.1)) +
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = 100)
```
...
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-area_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Disease_state, y= Mean_Puncta_mitoTracker_AreaShape_Area, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-area_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Metadata_SampleID, y= Mean_Puncta_mitoTracker_Number_Object_Number, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-count_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Disease_state, y= Mean_Puncta_mitoTracker_Number_Object_Number, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-count_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Metadata_SampleID, y= Mean_Puncta_mitoTracker_Intensity_MeanIntensity_Corr_mitoTracker, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-intensity_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Disease_state, y= Mean_Puncta_mitoTracker_Intensity_MeanIntensity_Corr_mitoTracker, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-intensity_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Metadata_SampleID, y= mitoTracker_MeanArea, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-MeanArea_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Disease_state, y= mitoTracker_MeanArea, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-MeanArea_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
```
...
ggplot(data,aes(x= Metadata_SampleID, y= mitoTracker_MeanCount, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-MeanCount_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
...
ggplot(data,aes(x= Disease_state, y= mitoTracker_MeanCount, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-MeanCount_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
...
ggplot(data,aes(x= Metadata_SampleID, y= ObjectSkeleton_NumberBranchEnds_mitoTracker_Skeleton, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-BranchEnds_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
...
ggplot(data,aes(x= Disease_state, y= ObjectSkeleton_NumberBranchEnds_mitoTracker_Skeleton, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-BranchEnds_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
...
ggplot(data,aes(x= Metadata_SampleID, y= Branchpoints, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-Branchpoints_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
...
ggplot(data,aes(x= Disease_state, y= Branchpoints, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-Branchpoints_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
...
ggplot(data,aes(x= Metadata_SampleID, y= ObjectSkeleton_TotalObjectSkeletonLength_mitoTracker_Skeleton, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-SkeletonLength_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
...
ggplot(data,aes(x= Disease_state, y= ObjectSkeleton_TotalObjectSkeletonLength_mitoTracker_Skeleton, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-SkeletonLength_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
...
ggplot(data,aes(x= Metadata_SampleID, y= mitoTracker_MeanLength, group = Metadata_SampleID, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-Mean_SkeletonLength_violin-plot_patients.svg", width = 20, height = 6, units = "cm")
...
ggplot(data,aes(x= Disease_state, y= mitoTracker_MeanLength, group = Disease_state, color = Disease_state, fill = Disease_state) ) +
  ...
  geom_boxplot(width=0.1)+
  theme_classic() + geom_hline(yintercept = yint)
ggsave(filename = "results_mitoTracker/figures/data_mitoTracker-Mean_SkeletonLength_violin-plot_Disease-state.svg", width = 8, height = 6, units = "cm")
